  ...
  const algorithms = [
    {
      ...
      description:
        "Hisse senedinin aşırı alım veya aşırı satım durumunu belirlemek için momentumu ölçen teknik bir göstergedir.",
      parameters: [
        {
          name: "Period",
          desc: "RSI hesaplamasında kullanılacak gün sayısı (Varsayılan: 14)",
        },
        {
          name: "Oversold",
          desc: "Alım sinyali için aşırı satım seviye eşiği (Varsayılan: 30)",
        },
        {
          name: "Overbought",
          desc: "Satım sinyali için aşırı alım seviye eşiği (Varsayılan: 70)",
        },
      ],
      logic: {
        behavior:
          "Fiyat momentumunun hızını ve yönünü 0 ile 100 arasında bir skora dönüştürür. Aşırı uç değerler trend dönüşlerini işaret eder.",
    ...
    },
    {
      ...
      description:
        "İki farklı zaman periyoduna sahip hareketli ortalamanın kesişim noktalarını takip eden trend takipçi bir indikatördür.",
      parameters: [
        {
          name: "Fast Period",
          desc: "Kısa vadeli hareketli ortalama gün sayısı (Varsayılan: 10)",
        },
        {
          name: "Slow Period",
          desc: "Uzun vadeli hareketli ortalama gün sayısı (Varsayılan: 50)",
        },
      ],
      logic: {
        behavior:
          "Kısa vadeli ortalama (Hızlı SMA), uzun vadeli ortalamayı (Yavaş SMA) kestiğinde yön değişimi tespiti yapar.",
    ...
    },
    {
      ...
      description:
        "İki üssel hareketli ortalama (EMA) arasındaki ilişkiyi gösteren, trend takip eden dinamik bir momentum indikatörüdür.",
      parameters: [
        {
          name: "Fast EMA",
          desc: "Hızlı üssel ortalama periyodu (Varsayılan: 12)",
        },
        {
          name: "Slow EMA",
          desc: "Yavaş üssel ortalama periyodu (Varsayılan: 26)",
        },
        {
          name: "Signal EMA",
          desc: "MACD fark çizgisinin sinyal periyodu (Varsayılan: 9)",
        },
      ],
      logic: {
        behavior:
          "Hızlı EMA'dan yavaş EMA çıkarılarak MACD çizgisi elde edilir. Bu çizginin 9 periyotluk EMA'sı ise Sinyal çizgisini oluşturur.",
    ...
    },
    {
      ...
      description:
        "Fiyat oynaklığını (volatilite) standart sapma kullanarak ölçen ve fiyatın hareket alanını bantlar şeklinde çizen bir volatilite indikatörüdür.",
      parameters: [
        {
          name: "Period",
          desc: "Kanal ortalaması için kullanılacak hareketli ortalama gün sayısı (Varsayılan: 20)",
        },
        {
          name: "StdDev Multiplier",
          desc: "Kanal genişliğini belirleyen standart sapma katsayısı (Varsayılan: 2)",
        },
      ],
      logic: {
        behavior:
          "Orta bant 20 günlük SMA'dır. Üst ve alt bantlar ise bu SMA'ya 2 standart sapma eklenip çıkarılarak bulunur. Fiyat genelde bu kanalda hareket eder.",
    ...
    },
    {
      ...
      description:
        "Kullanıcıların kendi mantıksal kurallarını, göstergeleri ve sınır değerlerini belirleyerek özel alım-satım senaryoları tasarlayabileceği gelişmiş kural motorudur.",
      parameters: [
        {
          name: "Buy Conditions",
          desc: "Alım (BUY) emrinin tetiklenmesi için sağlanması gereken mantıksal koşullar listesi.",
        },
        {
          name: "Sell Conditions",
          desc: "Satım (SELL) emrinin tetiklenmesi için sağlanması gereken mantıksal koşullar listesi.",
        },
        {
          name: "Operator (AND/OR)",
          desc: "Koşulların hepsi mi sağlanmalı (AND) yoksa biri yeterli mi (OR) kuralı.",
        },
      ],
      logic: {
        behavior:
          "Kullanıcı tarafından oluşturulan kural bloklarını (örn: 'RSI(14) < 30 VE Fiyat > SMA(50)') gerçek zamanlı bar verileri üzerinde işler.",
          ...
          <Card key={algo.id} className="border-border bg-card overflow-hidden">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <Badge
                  variant="outline"
                  className="font-mono bg-zinc-900 text-xs shrink-0"
                >
                  {algo.id}
                </Badge>
                <svg
                ...
                <div className="border border-border rounded-lg overflow-hidden bg-zinc-900/15">
                  ...
                  <div className="divide-y divide-border">
                    {algo.parameters.map((param, i) => (
                      <div
                        key={i}
                        className="flex flex-col sm:flex-row px-4 py-2.5 sm:items-center gap-1 sm:gap-4 text-xs"
                      >
                        <span className="font-mono font-semibold text-zinc-300 sm:min-w-[120px]">
                          {param.name}
                        </span>
